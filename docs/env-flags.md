...
| `SHARPEMU_PS_FORCE_EXPOSURE_SCALAR=<float>` | Legacy targeted probe for the tonemap cbuffer word at byte 116 (known placements 0x500640200/0x500641900). Current captures show the real word is already 0.5; use `SHARPEMU_ASTRO_TONEMAP_FIX` for the confirmed blockers. |
